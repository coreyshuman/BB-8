...
#include "lib/usb/usb_common.h"         // Common USB library definitions
#include "lib/usb/usb_ch9.h"            // USB device framework definitions

#if defined( USB_SUPPORT_DEVICE )
    #include "lib/usb/usb_device.h"     // USB Device abstraction layer interface
#endif
...
#include "lib/usb/usb_hal.h"            // Hardware Abstraction Layer interface
