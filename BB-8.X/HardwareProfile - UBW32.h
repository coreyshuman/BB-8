...
#define RX_INPUT_7_IO      PORTGbits.RG13
#define RX_INPUT_7_TRIS     TRISGbits.TRISG13
#define RX_INPUT_8_IO      PORTGbits.RG12
#define RX_INPUT_8_TRIS     TRISGbits.TRISG12
