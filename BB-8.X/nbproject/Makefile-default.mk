...
${OBJECTDIR}/OLED_driver.o: OLED_driver.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/OLED_driver.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DPIC32MX795F512L_UBW32 -I"../../../Microchip/Include" -I".." -I"." -MMD -MF "${OBJECTDIR}/OLED_driver.o.d" -o ${OBJECTDIR}/OLED_driver.o OLED_driver.c   
	
${OBJECTDIR}/diagnostic.o: diagnostic.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/diagnostic.o.d 
	@${RM} ${OBJECTDIR}/diagnostic.o 
	@${FIXDEPS} "${OBJECTDIR}/diagnostic.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DPIC32MX795F512L_UBW32 -I"../../../Microchip/Include" -I".." -I"." -MMD -MF "${OBJECTDIR}/diagnostic.o.d" -o ${OBJECTDIR}/diagnostic.o diagnostic.c   
