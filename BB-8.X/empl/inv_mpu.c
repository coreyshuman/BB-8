...
//		printf("\r\nleft: %u ii: %u this_write: %u\r\n", length - ii, ii, this_write);
        ...
        if (memcmp(firmware+ii, cur, this_write))
		{
			...
			{
				printf("%x=%x | ", *(unsigned char *)(firmware+ii+i), *(unsigned char *)(cur+i));
			}
			printf("\r\n");
			return -2;
		}
...
//void raw_readings(unsigned char * data)
//{
//	i2c_read(st.hw->addr, st.reg->raw_accel, );
//}
